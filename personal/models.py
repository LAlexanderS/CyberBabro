...
class Personal(models.Model):
    ...
    rank = models.CharField(max_length=50,blank=True,null=True, verbose_name = 'Должность')
    sex = models.CharField(max_length=10,blank=True, null=True, verbose_name = 'Пол',choices=GENDER_CHOICES)
